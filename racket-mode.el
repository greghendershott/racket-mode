...
(defun racket-set-indentation ()
  ;; Indentation for some Racket (non-Scheme) forms
  ...
  (put 'with-float         'scheme-indent-function 1)
  (put 'with-fixed         'scheme-indent-function 1)
  ...
  (put 'for/flvector       'scheme-indent-function 1)
  (put 'for*               'scheme-indent-function 1)
  (put 'for*/list          'scheme-indent-function 1)
  (put 'for*/vector        'scheme-indent-function 1)
  (put 'for*/hash          'scheme-indent-function 1)
