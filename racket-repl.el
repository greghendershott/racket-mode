...
;; buffers has an always-buffer-local value for the variable
;; `racket--repl-session-id'. Note that each variable has no
;; particular meaning outside its use by each mode.
