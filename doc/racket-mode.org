...
{{{img(scenario-0,One local back end)}}}
...
{{{img(scenario-1,Two local back ends)}}}
...
{{{img(scenario-2,A back end on a remote host)}}}

Of course the remote can also use different back ends for different paths.

{{{img(scenario-3,Two back ends on a remote host)}}}

And of course you can have multiple remotes.

{{{img(scenario-4,Multiple remotes)}}}
